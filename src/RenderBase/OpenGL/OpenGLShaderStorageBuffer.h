...
namespace OBase
{
    ...
    public:
         ...
         * @param bindPoint  绑定点
         */
        virtual void ReLinkBindingPoint(uint8_t bindPoint) = 0;
    ...
    {
    public:
        explicit OpenGLShaderStorageBuffer(uint32_t size, uint8_t bindPoint);
        ...
        void ReLinkBindingPoint(uint8_t bindPoint) override;
