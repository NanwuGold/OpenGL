...
namespace OBase
{
    void EmptyCaseLayer::OnEvent(Event &event)
    {
        Layer::OnEvent(event);
    }

    EmptyCaseLayer::EmptyCaseLayer(const std::string &name)
            : Layer(name)
    {
    }

    EmptyCaseLayer::~EmptyCaseLayer()
    {
    }

    void EmptyCaseLayer::OnAttach()
    {
        Init();
    }

    void EmptyCaseLayer::OnDetach()
    {
        Destory();
    }

    void EmptyCaseLayer::OnUpdate(Timestep ts)
    {
    ...
    void EmptyCaseLayer::OnImGuiRender()
    {
