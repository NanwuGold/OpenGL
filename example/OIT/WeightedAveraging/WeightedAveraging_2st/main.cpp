...
int main()
{
    ...
    context->Init();
    const auto triangleShader = std::make_shared<OpenGLShader>("./Shaders/WA2_triangle.vert", "./Shaders/WA2_triangle.frag");
    ...
    const auto quadShader = std::make_shared<OpenGLShader>("./Shaders/WA2_quad.vert", "./Shaders/WA2_quad.frag");
